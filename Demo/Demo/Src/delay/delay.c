...
#define delay_osrunning		osKernelRunning()   //OS是否运行标记,0,不运行;1,在运行
...
{	
	if(delay_osrunning)//如果OS已经在跑了,并且不是在中断里面(中断里面不能任务调度)	  delay_osintnesting==0  
	{		 
